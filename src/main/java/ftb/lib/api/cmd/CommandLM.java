...
public abstract class CommandLM extends CommandBase // CommandFTBU CommandSubLM
{
    ...
    public boolean canCommandSenderUseCommand(ICommandSender ics) {
        ...
        return level != CommandLevel.NONE
                && (level == CommandLevel.ALL || !FTBLib.isDedicatedServer() || super.canCommandSenderUseCommand(ics));
    }
    ...
    public String[] getTabStrings(ICommandSender ics, String args[], int i) throws CommandException {
        ...
        for (EntityPlayerMP ep : FTBLib.getAllOnlinePlayers(null)) l.add(ep.getGameProfile().getName());
