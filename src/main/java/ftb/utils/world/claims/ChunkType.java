...
public class ChunkType {
    ...
    public static final ChunkType WILDERNESS =
            new ChunkType(-3, "wilderness", EnumChatFormatting.DARK_GREEN, 0xFF2F9E00);
    ...
    public static final ChunkType[] UNCLAIMED_VALUES = new ChunkType[] {
        UNLOADED, SPAWN, WORLD_BORDER, WILDERNESS, LOADED_SELF,
    };
