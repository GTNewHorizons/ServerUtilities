...
public class AuroraConfig {
    ...
    public static boolean sync() {
        ...
        //general.modlist_page = config.get(GEN_CAT,"modlist_page", "ENABLED", "Enable the modlist page, Valid values: ENABLED, REQUIRES_AUTH, DISABLED");
        //general.world_info_json = config.get(GEN_CAT,"world_info_json", false, "Enable the world info page, Default: false");
        //general.player_list_table = config.get(GEN_CAT,"player_list_table", false, "Enable the playerlist table page, Default: false");
        //general.player_list_json = (PageType) config.get(GEN_CAT,"player_list_json", false, "Enable the playerlist json page, Default: false");
        //general.modlist_excluded_mods = config.get("modlist_excluded_mods",GEN_CAT,new String[] {}, "Exclude mods from the modlist: Default: Empty" ).getStringList();
