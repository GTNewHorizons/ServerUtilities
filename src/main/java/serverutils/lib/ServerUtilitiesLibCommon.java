...
public class ServerUtilitiesLibCommon {
	...
	public void init(FMLInitializationEvent event) {
		...
		registry.registerAdminPanelAction(new AdminPanelAction(ServerUtilitiesLib.MOD_ID, "reload", GuiIcons.REFRESH, -1000) {
			@Override
			...
			public void onAction(ForgePlayer player, NBTTagCompound data) {
				ServerUtilitiesLibAPI.reloadServer(player.team.universe, player.getPlayer(), EnumReloadType.RELOAD_COMMAND, ServerReloadEvent.ALL);
			}
