...
public class ServerUtilitiesLibClientEventHandler {

	public static final ServerUtilitiesLibClientEventHandler INST = new ServerUtilitiesLibClientEventHandler();
	...
	public void onTooltip(ItemTooltipEvent event) {
		if (ServerUtilitiesLibClientConfig.item_ore_names) {
		...
		if (ServerUtilitiesLibClientConfig.item_nbt && GuiScreen.isShiftKeyDown()) {
	...
	public void onDebugInfoEvent(RenderGameOverlayEvent.Text event) {
		if (ServerUtilitiesLibClientConfig.debug_helper && !Minecraft.getMinecraft().gameSettings.showDebugInfo
	...
	public void onCustomClick(CustomClickEvent event) {
		if (event.getID().getResourceDomain().equals(ServerUtilitiesLib.MOD_ID)) {
	...
	private static class GuiButtonSidebarGroup extends GuiButton {
		...
		public void drawButton(Minecraft mc, int mx, int my) {
			...
			int rx, ry = 0;
			boolean addedAny;
			boolean top = ServerUtilitiesLibClientConfig.action_buttons.top() || !gui.mc.thePlayer.getActivePotionEffects().isEmpty();
