...
public enum EnumTeamStatus implements IStringSerializable {
	...
	public static final BiFunction<ICommandSender, EnumTeamStatus, IChatComponent> NAME_GETTER = (sender, value) -> StringUtils.color(ServerUtilitiesLib.lang(sender, value.getLangKey()), value.getColor());
