...
public class ServerUtilitiesLibTeamGuiActions {
	...
	public static final TeamAction CONFIG = new TeamAction(ServerUtilitiesLib.MOD_ID, "config", GuiIcons.SETTINGS, -100) {
		...
		public void onAction(ForgePlayer player, NBTTagCompound data) {
			ServerUtilitiesLibAPI.editServerConfig(player.getPlayer(), player.team.getSettings(), player.team);
		}
	...
	public static final TeamAction MEMBERS = new TeamAction(ServerUtilitiesLib.MOD_ID, "members", GuiIcons.FRIENDS, 30) {
	...
	public static final TeamAction MODERATORS = new TeamAction(ServerUtilitiesLib.MOD_ID, "moderators", GuiIcons.SHIELD, 50) {
	...
	public static final TeamAction LEAVE = new TeamAction(ServerUtilitiesLib.MOD_ID, "leave", GuiIcons.REMOVE, 10000) {
		...
		public void onAction(ForgePlayer player, NBTTagCompound data) {
			...
			ServerUtilitiesLibAPI.sendCloseGuiPacket(player.getPlayer());
		}
	}.setRequiresConfirm();
