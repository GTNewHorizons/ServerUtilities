...
import serverutils.lib.events.team.ForgeTeamSavedEvent;
import serverutils.lib.events.universe.PersistentScheduledTaskEvent;
...
public class Universe {
	...
	public ForgePlayer getPlayer(GameProfile profile) {
		...
		if (player == null && ServerUtilitiesLibConfig.general.merge_offline_mode_players.get(!server.isDedicatedServer())) {
