package serverutils.lib.lib.icon;
...
import serverutils.lib.lib.EnumDyeColor;
...
public class Color4I extends Icon {
	...
	static {
		...
		int[] colors256 = { 0x000000, 0x252525, 0x343434, 0x4E4E4E, 0x686868, 0x757575, 0x8E8E8E, 0xA4A4A4, 0xB8B8B8,
				0xC5C5C5, 0xD0D0D0, 0xD7D7D7, 0xE1E1E1, 0xEAEAEA, 0xF4F4F4, 0xFFFFFF, 0x412000, 0x542800, 0x763700,
				0x9A5000, 0xC36806, 0xE47B07, 0xFF911A, 0xFFAB1D, 0xFFC51F, 0xFFD03B, 0xFFD84C, 0xFFE651, 0xFFF456,
				0xFFF970, 0xFFFF90, 0xFFFFAA, 0x451904, 0x721E11, 0x9F241E, 0xB33A20, 0xC85120, 0xE36920, 0xFC8120,
				0xFD8C25, 0xFE982C, 0xFFAE38, 0xFFB946, 0xFFBF51, 0xFFC66D, 0xFFD587, 0xFFE498, 0xFFE6AB, 0x5D1F0C,
				0x7A240D, 0x982C0E, 0xB02F0F, 0xBF3624, 0xD34E2A, 0xE7623E, 0xF36E4A, 0xFD7854, 0xFF8A6A, 0xFF987C,
				0xFFA48B, 0xFFB39E, 0xFFC2B2, 0xFFD0C3, 0xFFDAD0, 0x4A1700, 0x721F00, 0xA81300, 0xC8210A, 0xDF2512,
				0xEC3B24, 0xFA5236, 0xFC6148, 0xFF705F, 0xFF7E7E, 0xFF8F8F, 0xFF9D9E, 0xFFABAD, 0xFFB9BD, 0xFFC7CE,
				0xFFCADE, 0x490036, 0x66004B, 0x80035F, 0x950F74, 0xAA2288, 0xBA3D99, 0xCA4DA9, 0xD75AB6, 0xE467C3,
				0xEF72CE, 0xFB7EDA, 0xFF8DE1, 0xFF9DE5, 0xFFA5E7, 0xFFAFEA, 0xFFB8EC, 0x48036C, 0x5C0488, 0x650D90,
				0x7B23A7, 0x933BBF, 0x9D45C9, 0xA74FD3, 0xB25ADE, 0xBD65E9, 0xC56DF1, 0xCE76FA, 0xD583FF, 0xDA90FF,
				0xDE9CFF, 0xE2A9FF, 0xE6B6FF, 0x051E81, 0x0626A5, 0x082FCA, 0x263DD4, 0x444CDE, 0x4F5AEC, 0x5A68FF,
				0x6575FF, 0x7183FF, 0x8091FF, 0x90A0FF, 0x97A9FF, 0x9FB2FF, 0xAFBEFF, 0xC0CBFF, 0xCDD3FF, 0x0B0779,
				0x201C8E, 0x3531A3, 0x4642B4, 0x5753C5, 0x615DCF, 0x6D69DB, 0x7B77E9, 0x8985F7, 0x918DFF, 0x9C98FF,
				0xA7A4FF, 0xB2AFFF, 0xBBB8FF, 0xC3C1FF, 0xD3D1FF, 0x1D295A, 0x1D3876, 0x1D4892, 0x1D5CAC, 0x1D71C6,
				0x3286CF, 0x489BD9, 0x4EA8EC, 0x55B6FF, 0x69CAFF, 0x74CBFF, 0x82D3FF, 0x8DDAFF, 0x9FD4FF, 0xB4E2FF,
				0xC0EBFF, 0x004B59, 0x005D6E, 0x006F84, 0x00849C, 0x0099BF, 0x00ABCA, 0x00BCDE, 0x00D0F5, 0x10DCFF,
				0x3EE1FF, 0x64E7FF, 0x76EAFF, 0x8BEDFF, 0x9AEFFF, 0xB1F3FF, 0xC7F6FF, 0x004800, 0x005400, 0x036B03,
				0x0E760E, 0x188018, 0x279227, 0x36A436, 0x4EB94E, 0x51CD51, 0x72DA72, 0x7CE47C, 0x85ED85, 0x99F299,
				0xB3F7B3, 0xC3F9C3, 0xCDFCCD, 0x164000, 0x1C5300, 0x236600, 0x287800, 0x2E8C00, 0x3A980C, 0x47A519,
				0x51AF23, 0x5CBA2E, 0x71CF43, 0x85E357, 0x8DEB5F, 0x97F569, 0xA0FE72, 0xB1FF8A, 0xBCFF9A, 0x2C3500,
				0x384400, 0x445200, 0x495600, 0x607100, 0x6C7F00, 0x798D0A, 0x8B9F1C, 0x9EB22F, 0xABBF3C, 0xB8CC49,
				0xC2D653, 0xCDE153, 0xDBEF6C, 0xE8FC79, 0xF2FFAB, 0x463A09, 0x4D3F09, 0x544509, 0x6C5809, 0x907609,
				0xAB8B0A, 0xC1A120, 0xD0B02F, 0xDEBE3D, 0xE6C645, 0xEDCD4C, 0xF5D862, 0xFBE276, 0xFCEE98, 0xFDF3A9,
				0xFDF3BE, 0x401A02, 0x581F05, 0x702408, 0x8D3A13, 0xAB511F, 0xB56427, 0xBF7730, 0xD0853A, 0xE19344,
				0xEDA04E, 0xF9AD58, 0xFCB75C, 0xFFC160, 0xFFCA69, 0xFFCF7E, 0xFFDA96, };
	...
	public static Color4I getChatFormattingColor(@Nullable EnumChatFormatting formatting) {
	...
	public static Color4I rgb(double r, double g, double b) {
	...
	public void draw(int x, int y, int w, int h) {
		...
		GuiHelper.addRectToBuffer(tessellator, x, y, w, h, this);
		tessellator.draw();
	...
	public Color4I lerp(Color4I col, float m) {
		m = MathHelper.clamp_float(m, 0F, 1F);
	...
	public Color4I addBrightness(float percent) {
		...
		return rgb(java.awt.Color.HSBtoRGB(hsb[0], hsb[1], MathHelper.clamp_float(hsb[2] + percent, 0F, 1F)))
				.withAlpha(alphai());
	}
