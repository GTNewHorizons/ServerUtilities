...
import serverutils.old.mod.client.gui.guide.ButtonGuideTextLine;
...
public class GuidePlayerViewLine extends GuideTextLine {
    ...
    public class ButtonGuidePlayerView extends ButtonGuideTextLine {
        ...
        public void renderWidget() {
            ...
            ServerUtilitiesLibraryClient.setTexture(player.getLocationSkin());
            ...
            GuiInventory.func_147046_a(
                    ...
                    pheight,
                    playerX - gui.mouse().x,
                    playerY - (pheight + (pheight / 1.625F)) - gui.mouse().y,
                    player);
