...
public class ServerUtilitiesNetHandler {
    ...
    static final LMNetworkWrapper NET = LMNetworkWrapper.newWrapper("SVRU");
    static final LMNetworkWrapper NET_INFO = LMNetworkWrapper.newWrapper("SVRUI");
    static final LMNetworkWrapper NET_WORLD = LMNetworkWrapper.newWrapper("SVRUW");
