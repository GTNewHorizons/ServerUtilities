package serverutils.old.world.claims;
...
public class ChunkType {
    ...
    public static final ChunkType WILDERNESS = new ChunkType(
            -3,
            "wilderness",
    ...
    public static final ChunkType[] UNCLAIMED_VALUES = new ChunkType[] { UNLOADED, SPAWN, WORLD_BORDER, WILDERNESS,
            LOADED_SELF, };
    ...
    public String getIDS() {
        return ServerUtilities.mod.translate(lang);
    }
