...
public class ServerLib {
	...
	@SidedProxy(
			serverSide = "serverutils.serverlib.ServerLibCommon", 
			clientSide = "client.serverutils.ServerLibClient")																	 																			
	public static ServerLibCommon PROXY;

	@GameRegistry.ObjectHolder("severlibquests:custom_icon")
	...
	public void onPreInit(FMLPreInitializationEvent event) {
		...
		PROXY.preInit(event);
		MinecraftForge.EVENT_BUS.register(ServerLibConfig.INST);
		MinecraftForge.EVENT_BUS.register(ServerLibEventHandler.INST);
		FMLCommonHandler.instance().bus().register(ServerLibEventHandler.INST);
	}
