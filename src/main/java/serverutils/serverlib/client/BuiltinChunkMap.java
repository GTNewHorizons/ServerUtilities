...
import serverutils.serverlib.lib.gui.misc.GuiChunkSelectorBase;
...
public class BuiltinChunkMap extends ChunkSelectorMap {
	public static final Icon TEX_ENTITY = Icon.getIcon(ServerLib.MOD_ID + ":textures/gui/entity.png").withColor(Color4I.WHITE.withAlpha(140));
