...
public class ServerLibClientConfig {
	...
	public static final ServerLibClientConfig INST = new ServerLibClientConfig();

	public static void init(FMLPreInitializationEvent event) {
		config = new Configuration(new File(event.getModConfigurationDirectory() + "/../local/client/serverlib.cfg"));
		sync();
	}
