...
import serverutils.serverlib.lib.util.ChainedBooleanSupplier;
...
public class SidebarButton implements Comparable<SidebarButton> {
	...
	{
		return configValue && ServerLibClientConfig.action_buttons != EnumSidebarButtonPlacement.DISABLED && isVisible();
	}
