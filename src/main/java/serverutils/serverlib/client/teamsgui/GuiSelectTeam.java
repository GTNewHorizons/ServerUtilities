...
public class GuiSelectTeam extends GuiButtonListBase {
	...
	private static class ButtonTeam extends SimpleTextButton
	{
		...
		public void addMouseOverText(List<String> list)
		{
			...
			{
				list.add(EnumChatFormatting.GRAY + I18n.format(team.type == PublicTeamData.Type.CAN_JOIN ? "serverlib.lang.team.gui.join_team" : "serverlib.lang.team.gui.request_invite", team.color.getTextFormatting() + team.getId() + EnumChatFormatting.GRAY));
			}
		}
