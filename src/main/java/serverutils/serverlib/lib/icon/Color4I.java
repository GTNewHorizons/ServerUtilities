...
public class Color4I extends Icon
{
	...
	public static Color4I getDyeColor(ItemDye color, boolean isLighter)
	{
	...
	public void draw(int x, int y, int w, int h)
	{
		...
		BufferBuilder buffer = tessellator..getRawBuffer(); //BufferBuilder buffer = tessellator.getBuffer();
		buffer.begin(GL11.GL_QUADS, tessellator.setColorRGBA(red, green, blue, alpha); //DefaultVertexFormats.POSITION_COLOR);
	...
	{
		m = MathHelper.clampFloat(m, 0F, 1F);
	...
	public Color4I addBrightness(float percent)
	{
		...
		return rgb(java.awt.Color.HSBtoRGB(hsb[0], hsb[1], MathHelper.clampFloat(hsb[2] + percent, 0F, 1F))).withAlpha(alphai());
	}
