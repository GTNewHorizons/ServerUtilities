...
import serverutils.serverlib.lib.io.ByteCounterOutputStream;
...
public class NBTUtils
{
	...
	public static void copyTags(@Nullable NBTTagCompound from, @Nullable NBTTagCompound to)
	{
		...
		{
			for (Object k : from.func_150296_c())
			{
				String key = (String) k;
	...
	private static final EnumChatFormatting[] COLORS = {EnumChatFormatting.BLUE, EnumChatFormatting.DARK_GREEN, EnumChatFormatting.YELLOW, EnumChatFormatting.RED};
	...
	private static StringBuilder getColoredNBTString(StringBuilder builder, @Nullable NBTBase nbt, int level)
	{
		...
		switch (nbt.getId())
		{
			...
			case Constants.NBT.TAG_COMPOUND:
			{
				...
				for (Object k : map.func_150296_c())
				{
					String key = (String) k;
					if (first)
					{
