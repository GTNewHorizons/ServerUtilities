...
public class IChunUtilIntegration {
    ...
    // if (event.getEntityLiving() instanceof EntityPlayerMP && ClaimedChunks
    // .blockBlockEditing((EntityPlayerMP) event.getEntityLiving(), event.getPos(), event.getBlockState())) {
    // event.setCanceled(true);
    // }
    // }
}
